...
NINEROUTER_DEFAULT_BASE = "http://localhost:20128/v1"
OMLX_DEFAULT_BASE = "http://localhost:10240/v1"
...
PROVIDER_CATALOG: dict[str, ProviderDescriptor] = {
    ...
    "ninerouter": ProviderDescriptor(
        provider_id="ninerouter",
        transport_type="openai_chat",
        static_credential="9routor",
        default_base_url=NINEROUTER_DEFAULT_BASE,
        base_url_attr="ninerouter_base_url",
        capabilities=("chat", "streaming", "tools", "thinking", "local"),
    ),
    "omlx": ProviderDescriptor(
        provider_id="omlx",
        transport_type="openai_chat",
        static_credential="omlx",
