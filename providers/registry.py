...
def _create_ninerouter(config: ProviderConfig, _settings: Settings) -> BaseProvider:
    from providers.ninerouter import NineRouterProvider

    return NineRouterProvider(config)


def _create_omlx(config: ProviderConfig, _settings: Settings) -> BaseProvider:
    from providers.omlx import OmlxProvider

    return OmlxProvider(config)
