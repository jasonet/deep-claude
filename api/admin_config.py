...
MASKED_SECRET = "********"
MANAGED_ENV_RELATIVE = Path(".config") / "deep-claude" / ".env"
...
SECTIONS: tuple[ConfigSectionSpec, ...] = (
    ...
    ConfigSectionSpec(
        "tools",
        "Tools",
        "Recommended companion tools for DeepSeek.",
    ),
)
...
FIELDS: tuple[ConfigFieldSpec, ...] = (
    ...
    ConfigFieldSpec(
        "DCC_SMOKE_MODEL_NVIDIA_NIM",
        "Smoke NVIDIA NIM Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "DCC_SMOKE_MODEL_OPEN_ROUTER",
        "Smoke OpenRouter Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "DCC_SMOKE_MODEL_DEEPSEEK",
        "Smoke DeepSeek Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "DCC_SMOKE_MODEL_LMSTUDIO",
        "Smoke LM Studio Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "DCC_SMOKE_MODEL_LLAMACPP",
        "Smoke llama.cpp Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "DCC_SMOKE_MODEL_OLLAMA",
        "Smoke Ollama Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "DCC_SMOKE_MODEL_KIMI",
        "Smoke Kimi Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "DCC_SMOKE_MODEL_WAFER",
        "Smoke Wafer Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "DCC_SMOKE_MODEL_OPENCODE",
        "Smoke OpenCode Zen Model",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "DCC_SMOKE_NIM_MODELS",
        "Smoke NIM Models",
        "smoke",
        advanced=True,
    ),
    ConfigFieldSpec(
        "DCC_SMOKE_NIM_EXTRA_MODELS",
...
def explicit_env_path() -> Path | None:
    """Return the explicit DCC_ENV_FILE path, when configured."""

    if explicit := os.environ.get("DCC_ENV_FILE"):
...
def render_env_file(values: Mapping[str, str], *, mask_secrets: bool = False) -> str:
    ...
    lines: list[str] = [
        "# Managed by Deep Claude Code /admin.",
            ...
            statuses.append(
                {
                    ...
                    "credential_url": descriptor.credential_url or "",
                }
            )
            continue
